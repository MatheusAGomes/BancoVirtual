...
public class TrocaSenhaGerente extends JFrame {
	...
	public void Alterar(Pessoas pessoa,Gerente gerente[],JPasswordField passwordAntigaSenha,JPasswordField passwordNovaSenha,JPasswordField passwordConfirmeASenha){
		String antigasenha = pessoa.senha;
		 
		if(String.valueOf(pessoa.criptografia(String.valueOf(passwordAntigaSenha.getPassword()))).equals(antigasenha))
		{
			...
			{
				JOptionPane.showMessageDialog(null,"As duas senhas não iguais");	
			}
			
		}
		else {
			
			JOptionPane.showMessageDialog(null,"Antiga senha incorreta");			
		}
	}
}
